...
%>
<!DOCTYPE html>
<html lang="zh-CN" data-page-scope="taDashboard">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title data-i18n="taDashboard.page.title">TA Profile Setup - TA Hiring System</title>
    <link rel="stylesheet" href="<%= contextPath %>/css/ta-dashboard.css">
</head>
<body>
    <div class="portal-shell portal-shell-ta">
        <aside class="portal-sidebar" data-i18n-aria-label="taDashboard.nav.aria">
            <p class="portal-brand" data-i18n="taDashboard.brand">TA Portal</p>
            <nav class="portal-nav">
                <a class="portal-nav-link" href="<%= contextPath %>/jsp/ta/job-list.jsp">
                    ...
                    <span data-i18n="taDashboard.nav.jobs">Jobs</span>
                </a>
                <a class="portal-nav-link" href="<%= contextPath %>/jsp/ta/application-status.jsp">
                    ...
                    <span data-i18n="taDashboard.nav.status">Status</span>
                </a>
                <span class="portal-nav-link is-disabled" aria-disabled="true">
                    ...
                    <span data-i18n="taDashboard.nav.aiMatch">AI Match</span>
                </span>
                <a class="portal-nav-link is-active" href="<%= contextPath %>/jsp/ta/dashboard.jsp">
                    ...
                    <span data-i18n="taDashboard.nav.profile">Profile</span>
                </a>
            </nav>
            <div class="portal-sidebar-bottom">
                <a class="portal-nav-link" href="<%= contextPath %>/login.jsp">
                    ...
                    <span data-i18n="common.portal.switchRoles">Switch Roles</span>
                </a>
            </div>
        </aside>
        ...
        <section class="portal-main">
            <header class="portal-topbar">
                ...
                <a class="portal-topbar-link" href="<%= contextPath %>/logout" data-i18n="common.portal.signOut">Sign Out</a>
            </header>

            <div class="portal-content">
                <main class="profile-page">
                    <section class="profile-hero" aria-labelledby="profile-page-title">
                        <h1 id="profile-page-title" data-i18n="taDashboard.hero.title">Profile</h1>
