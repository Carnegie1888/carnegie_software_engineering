...
<head>
    ...
    <title data-i18n="pages.taJobDetail.title">Job detail - TA Hiring System</title>
    <link rel="stylesheet" href="<%= contextPath %>/css/ta-job-detail.css">
</head>
<body>
    <div class="portal-shell portal-shell-ta">
        <aside class="portal-sidebar" data-i18n-aria-label="pages.common.sidebarAriaTa">
            <p class="portal-brand" data-i18n="pages.common.portalBrandTa">TA Portal</p>
            <nav class="portal-nav">
                <a class="portal-nav-link is-active" href="<%= contextPath %>/jsp/ta/job-list.jsp">
                    ...
                    <span data-i18n="pages.common.navJobs">Jobs</span>
                </a>
                <a class="portal-nav-link" href="<%= contextPath %>/jsp/ta/application-status.jsp">
                    ...
                    <span data-i18n="pages.common.navStatus">Status</span>
                </a>
                <span class="portal-nav-link is-disabled" aria-disabled="true">
                    ...
                    <span data-i18n="pages.common.navAiMatch">AI Match</span>
                </span>
                <a class="portal-nav-link" href="<%= contextPath %>/jsp/ta/dashboard.jsp">
                    ...
                    <span data-i18n="pages.common.navProfile">Profile</span>
                </a>
            </nav>
