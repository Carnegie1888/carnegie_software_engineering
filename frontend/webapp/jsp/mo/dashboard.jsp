...
<head>
    ...
    <title data-i18n="app.mo.dashboard.page.title">MO Dashboard - Post TA Jobs</title>
    <link rel="stylesheet" href="<%= contextPath %>/css/mo-dashboard.css">
</head>
<body>
    <div class="portal-shell portal-shell-mo">
        <aside class="portal-sidebar" data-i18n-aria-label="app.mo.sidebar.aria">
            <p class="portal-brand" data-i18n="app.mo.brand">MO Portal</p>
            <div class="portal-locale locale-switch" role="group" data-i18n-aria-label="common.locale.switchAria">
            ...
            <nav class="portal-nav">
                <a class="portal-nav-link" href="<%= contextPath %>/jsp/mo/overview.jsp">
                    ...
                    <span data-i18n="app.mo.nav.overview">Overview</span>
                </a>
                <a class="portal-nav-link" href="<%= contextPath %>/jsp/mo/applicant-selection.jsp">
                    ...
                    <span data-i18n="app.mo.nav.applicants">Applicants</span>
                </a>
                <a class="portal-nav-link is-active" href="<%= contextPath %>/jsp/mo/dashboard.jsp">
                    ...
                    <span data-i18n="app.mo.nav.postJob">Post Job</span>
                </a>
                <a class="portal-nav-link" href="<%= contextPath %>/jsp/mo/ai-skill-match.jsp">
                    ...
                    <span data-i18n="app.mo.nav.aiMatch">AI Match</span>
                </a>
                <a class="portal-nav-link" href="<%= contextPath %>/jsp/mo/ai-missing-skills.jsp">
                    ...
                    <span data-i18n="app.mo.nav.skillGaps">Skill Gaps</span>
                </a>
                <span class="portal-nav-link is-disabled" aria-disabled="true">
                    ...
                    <span data-i18n="app.mo.nav.settings">Settings</span>
                </span>
            </nav>
            <div class="portal-sidebar-bottom">
                <a class="portal-nav-link" href="<%= contextPath %>/login.jsp">
                    ...
                    <span data-i18n="app.shared.switchRoles">Switch Roles</span>
                </a>
            </div>
        </aside>
        ...
        <section class="portal-main">
            <header class="portal-topbar">
                ...
                <a class="portal-topbar-link" href="<%= contextPath %>/logout" data-i18n="app.shared.signOut">Sign Out</a>
            </header>
