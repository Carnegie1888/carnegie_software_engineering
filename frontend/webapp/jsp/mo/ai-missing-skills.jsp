...
<head>
    ...
    <title data-i18n="portal.page.moAiMissingSkills.title">AI Missing Skills - TA Hiring System</title>
        ...
        <section class="portal-main">
            <header class="portal-topbar">
                <div class="portal-topbar-menu">
                    ...
                    <span class="portal-topbar-page" data-i18n="portal.moAiMissingSkills.title">AI Missing Skills</span>
                </div>
            ...
            <div class="portal-content">
                <main class="ai-gap-page ai-module-page">
                    <section class="gap-hero ai-module-hero" aria-labelledby="gap-title">
                        <h1 id="gap-title" class="portal-page-title" data-i18n="portal.moAiMissingSkills.title">AI Missing Skills</h1>
