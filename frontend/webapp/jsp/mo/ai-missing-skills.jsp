...
<head>
    ...
    <title data-i18n="portal.mo.aiMissing.pageTitle">AI Missing Skills - TA Hiring System</title>
...
<body>
    <div class="portal-shell portal-shell-mo">
        <aside class="portal-sidebar" aria-label="MO portal navigation">
            <p class="portal-brand" data-i18n="portal.mo.brand">MO Portal</p>
            <nav class="portal-nav">
                <a class="portal-nav-link" href="<%= contextPath %>/jsp/mo/overview.jsp">
                    ...
                    <span data-i18n="portal.mo.nav.overview">Overview</span>
                </a>
                <a class="portal-nav-link" href="<%= contextPath %>/jsp/mo/applicant-selection.jsp">
                    ...
                    <span data-i18n="portal.mo.nav.applicants">Applicants</span>
                </a>
                <a class="portal-nav-link" href="<%= contextPath %>/jsp/mo/dashboard.jsp">
                    ...
                    <span data-i18n="portal.mo.nav.postJob">Post Job</span>
                </a>
                <a class="portal-nav-link" href="<%= contextPath %>/jsp/mo/ai-skill-match.jsp">
                    ...
                    <span data-i18n="portal.mo.nav.aiMatch">AI Match</span>
                </a>
                <a class="portal-nav-link is-active" href="<%= contextPath %>/jsp/mo/ai-missing-skills.jsp">
                    ...
                    <span data-i18n="portal.mo.nav.skillGaps">Skill Gaps</span>
                </a>
                <span class="portal-nav-link is-disabled" aria-disabled="true">
                    ...
                    <span data-i18n="portal.mo.nav.settings">Settings</span>
                </span>
            </nav>
            <div class="portal-sidebar-bottom">
                <a class="portal-nav-link" href="<%= contextPath %>/login.jsp">
                    ...
                    <span data-i18n="portal.common.switchRoles">Switch Roles</span>
                </a>
            </div>
        </aside>
        ...
        <section class="portal-main">
            <header class="portal-topbar">
                ...
                <div class="portal-topbar-actions">
                    ...
                    <a class="portal-topbar-link" href="<%= contextPath %>/logout" data-i18n="portal.common.signOut">Sign Out</a>
                </div>
            </header>
            ...
            <div class="portal-content">
                <main class="ai-gap-page ai-module-page">
                    <section class="gap-hero ai-module-hero" aria-labelledby="gap-title">
                        <h1 id="gap-title" data-i18n="portal.mo.aiMissing.title">AI Missing Skills</h1>
