...
<head>
    ...
    <title data-i18n="pages.moApplicantSelection.title">Applicant review - TA Hiring System</title>
...
<body>
    <div class="portal-shell portal-shell-mo">
        <aside class="portal-sidebar" aria-label="MO portal navigation">
            <p class="portal-brand" data-i18n="pages.common.moPortalBrand">MO Portal</p>
            <nav class="portal-nav">
                <a class="portal-nav-link" href="<%= contextPath %>/jsp/mo/overview.jsp">
                    ...
                    <span data-i18n="pages.common.moNav.overview">Overview</span>
                </a>
                <a class="portal-nav-link is-active" href="<%= contextPath %>/jsp/mo/applicant-selection.jsp">
                    ...
                    <span data-i18n="pages.common.moNav.applicants">Applicants</span>
                </a>
                <a class="portal-nav-link" href="<%= contextPath %>/jsp/mo/dashboard.jsp">
                    ...
                    <span data-i18n="pages.common.moNav.postJob">Post Job</span>
                </a>
                <a class="portal-nav-link" href="<%= contextPath %>/jsp/mo/ai-skill-match.jsp">
                    ...
                    <span data-i18n="pages.common.moNav.aiMatch">AI Match</span>
                </a>
                <a class="portal-nav-link" href="<%= contextPath %>/jsp/mo/ai-missing-skills.jsp">
                    ...
                    <span data-i18n="pages.common.moNav.skillGaps">Skill Gaps</span>
                </a>
                <span class="portal-nav-link is-disabled" aria-disabled="true">
                    ...
                    <span data-i18n="pages.common.moNav.settings">Settings</span>
                </span>
            </nav>
            <div class="portal-sidebar-bottom">
                <a class="portal-nav-link" href="<%= contextPath %>/login.jsp">
                    ...
                    <span data-i18n="pages.common.switchRoles">Switch Roles</span>
                </a>
            </div>
        </aside>
        ...
        <section class="portal-main">
            <header class="portal-topbar">
                ...
                <div class="portal-topbar-actions">
                    ...
                    <a class="portal-topbar-link" href="<%= contextPath %>/logout" data-i18n="pages.common.signOut">Sign Out</a>
                </div>
            </header>
