...
%>
<!DOCTYPE html>
<html lang="zh-CN" data-page-scope="mo">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title data-i18n="page.mo.overview.title">MO Overview - TA Hiring System</title>
    <link rel="stylesheet" href="<%= contextPath %>/css/mo-overview.css">
</head>
<body>
    <div class="portal-shell portal-shell-mo">
        <aside class="portal-sidebar" data-i18n-aria-label="page.mo.sidebarAria">
            <p class="portal-brand" data-i18n="page.mo.portalBrand">MO Portal</p>
            <nav class="portal-nav">
                <a class="portal-nav-link is-active" href="<%= contextPath %>/jsp/mo/overview.jsp">
                    ...
                    <span data-i18n="page.mo.nav.overview">Overview</span>
                </a>
                <a class="portal-nav-link" href="<%= contextPath %>/jsp/mo/applicant-selection.jsp">
                    ...
                    <span data-i18n="page.mo.nav.applicants">Applicants</span>
                </a>
                <a class="portal-nav-link" href="<%= contextPath %>/jsp/mo/dashboard.jsp">
                    ...
                    <span data-i18n="page.mo.nav.postJob">Post Job</span>
                </a>
                <a class="portal-nav-link" href="<%= contextPath %>/jsp/mo/ai-skill-match.jsp">
                    ...
                    <span data-i18n="page.mo.nav.aiMatch">AI Match</span>
                </a>
                <a class="portal-nav-link" href="<%= contextPath %>/jsp/mo/ai-missing-skills.jsp">
                    ...
                    <span data-i18n="page.mo.nav.skillGaps">Skill Gaps</span>
                </a>
                <span class="portal-nav-link is-disabled" aria-disabled="true">
                    ...
                    <span data-i18n="page.mo.nav.settings">Settings</span>
                </span>
            </nav>
            <div class="portal-sidebar-bottom">
                <a class="portal-nav-link" href="<%= contextPath %>/login.jsp">
                    ...
                    <span data-i18n="page.common.switchRoles">Switch Roles</span>
                </a>
            </div>
        </aside>
        ...
        <section class="portal-main">
            <header class="portal-topbar">
                ...
                <div class="portal-topbar-tools">
                    ...
                    <a class="portal-topbar-link" href="<%= contextPath %>/logout" data-i18n="page.common.signOut">Sign Out</a>
                </div>
            </header>
