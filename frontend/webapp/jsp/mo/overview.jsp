...
<head>
    ...
    <title data-i18n="portal.page.moOverview.title">MO Overview - TA Hiring System</title>
        ...
        <section class="portal-main">
            <header class="portal-topbar">
                <div class="portal-topbar-menu">
                    ...
                    <span class="portal-topbar-page" data-i18n="portal.nav.mo.overview">Overview</span>
                </div>
            ...
            <div class="portal-content">
                <main class="mo-overview-page">
                    <section class="overview-hero" aria-labelledby="overview-title">
                        <h1 id="overview-title" class="portal-page-title" data-i18n="portal.nav.mo.overview">Overview</h1>
