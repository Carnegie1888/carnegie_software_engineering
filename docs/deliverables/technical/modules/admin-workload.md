...
```javascript
// 加载系统统计
TARecruitment.api.request(TARecruitment.routes.admin.workloadStatistics(), {
    headers: { "X-Requested-With": "XMLHttpRequest" }
});

// 加载 MO 统计
TARecruitment.api.request(TARecruitment.routes.admin.workloadStatistics({ mode: "mo" }), {
    headers: { "X-Requested-With": "XMLHttpRequest" }
});

// 加载 TA 统计
TARecruitment.api.request(TARecruitment.routes.admin.workloadStatistics({ mode: "ta" }), {
    headers: { "X-Requested-With": "XMLHttpRequest" }
});
```
