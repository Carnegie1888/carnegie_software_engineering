...
public final class MatchAnalysisAiConfig {
    ...
    private static final String LOCAL_CONFIG_PATH = "/WEB-INF/ai/match-analysis.local.properties";
    ...
    private MatchAnalysisAiConfig(String apiKey, String baseUrl, String model, long timeoutMillis) {
    ...
    public static MatchAnalysisAiConfig load(ServletContext servletContext) {
        ...
        return new MatchAnalysisAiConfig(apiKey, baseUrl, model, timeout);
    }
    ...
    private static Properties loadLocalProperties(ServletContext servletContext) {
        ...
        try (InputStream inputStream = servletContext.getResourceAsStream(LOCAL_CONFIG_PATH)) {
            ...
            servletContext.log("Failed to load match analysis AI local config: " + LOCAL_CONFIG_PATH, e);
        }
        return properties;
    }
